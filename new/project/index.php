...
<div class="form-group col-md-4"><input value="0" type="hidden" name="hora" class="form-control" placeholder="Horas estimadas" maxlength="4"></div>
</div>
...
<div class="form-group col-md-4"><input value="0" type="text" name="valorgasto" class="form-control" placeholder="Valor estimativo" maxlength="4"></div>
</div>
