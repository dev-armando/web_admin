...
//if( !isset($_SESSION['usuario_adm'])  ) exit("ERROR 404");
...
<a class="dropdown-item" <?=  "href='". incluir_file_var("new/recurso/index.php" , array('control' => 's' )) ."'"  ?> >Nuevo Usuario</a>
...
<a class="btn btn-sm border rounded-pill" <?=  "href='". incluir_file_var('dev/index.php' , array('control' => 's' )) ."'"  ?> ><i class="fa fa-plus"></i> Cargar Horas</a>


<a class="btn btn-sm border rounded-pill" <?=  "href='". incluir_file_var('reporte.php' , array('control' => 's' )) ."'"  ?> ><i class="fa fa-book"></i> Generar Reporte</a>
