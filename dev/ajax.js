        ...
        data.map(function (project) {
            ...
            var tr = ` 
                <tr>
                    ...
                    <td><a href="add/?@=${ project.idp }" title="Cargar Horas" >
                            <i class="fa fa-clock"   ></i>
                    </a> 
                    <a href="ver/?@=${ project.idp }"  title="Historial de Horas" >
                        <i class="fa fa-book"   ></i>
                    </a>

                    <a href="../reportes/?idp=${ project.idp }&tipo=recurso"   title="Exportar en Excel" >
